...
def run_scenar_2_a_task_4(task_id: str, params: dict, queue: str = 'default'):
    ...
    return BashOperator(
        ...
        task="{{ params.task | default('task_4') }}"
        ...
        if [[ -n "$last_result" ]]; then
          ...
          if [[ -n "$end_time" ]]; then
            ...
            python3 /opt/airflow/scripts/task4_copy_s3_to_postgres.py \
              -st "$end_time" \
              -wf "$workflow_number" \

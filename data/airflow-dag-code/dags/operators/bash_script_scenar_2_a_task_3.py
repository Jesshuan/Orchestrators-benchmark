...
def run_scenar_2_a_task_3(task_id: str, params: dict, queue: str = 'default'):
    ...
    return BashOperator(
        ...
        task="{{ params.task | default('task_3') }}"
        ...
        if [[ -n "$last_result" ]]; then
          ...
          if [[ -n "$end_time" ]]; then
            ...
            python3 /opt/airflow/scripts/task3_wait_external_service.py \
              -st "$end_time" \
              -wf "$workflow_number" \
